...
OBSTACLE_RADIUS             = 0.16  # meters 0.16
...
STEP_TIME       = 0.01      # Delay between steps, can be set to 0   0.01
EPSILON_DECAY   = 0.9995    # Epsilon decay per step 0.9995
EPSILON_MINIMUM = 0.05		# 0.05
