...
class Actor(Network):
    def __init__(self, name, state_size, action_size, hidden_size, num_heads = 4):
        ...
        self.hlstm1 = nn.LSTM(input_size=self.hidden_size, hidden_size=self.hidden_size, batch_first=True)
        self.hlstm2 = nn.LSTM(input_size=self.hidden_size, hidden_size=self.hidden_size, batch_first=True) 
    ...
    def forward(self, states, his_state, his_len, visualize=False):
        ...
        his_input, _ = self.hlstm1(his_input)
        his_input, _ = self.hlstm2(his_input)
        ...
        feat = torch.mean(his_input, dim=1)
...
class Critic(Network):
    def __init__(self, name, state_size, action_size, hidden_size, num_heads = 4):
        ...
        self.hlstm1_1 = nn.LSTM(input_size=self.hidden_size, hidden_size=self.hidden_size, batch_first=True)
        self.hlstm1_2 = nn.LSTM(input_size=self.hidden_size, hidden_size=self.hidden_size, batch_first=True) 
        ...
        self.hlstm2_1 = nn.LSTM(input_size=self.hidden_size, hidden_size=self.hidden_size, batch_first=True)
        self.hlstm2_2 = nn.LSTM(input_size=self.hidden_size, hidden_size=self.hidden_size, batch_first=True)
    ...
    def forward(self, states, actions, his_state, his_action, his_len):
        ...
        hs_1, _ = self.hlstm1_1(hs_1)
        hs_1, _ = self.hlstm1_2(hs_1)  # 
        hs_2, _ = self.hlstm2_1(hs_2)
        hs_2, _ = self.hlstm2_2(hs_2)  # 

        feat_1 = torch.mean(hs_1, dim=1)

        feat_2 = torch.mean(hs_2, dim=1)
