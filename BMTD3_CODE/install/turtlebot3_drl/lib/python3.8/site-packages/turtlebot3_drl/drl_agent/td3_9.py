...
class Actor(Network):
    def __init__(self, name, state_size, action_size, hidden_size, num_heads = 8):
        ...
        self.hlstm = nn.ModuleList([WeightedBiGRU(input_dim=self.hidden_size, hidden_dim=self.hidden_size)])

        self.attention = MultiHeadAttention(self.hidden_size, num_heads=num_heads)
...
class Critic(Network):
    def __init__(self, name, state_size, action_size, hidden_size, num_heads = 8):
        ...
        self.hlstm1 = nn.ModuleList([WeightedBiGRU(input_dim=self.hidden_size, hidden_dim=self.hidden_size)])


        self.attention1 = MultiHeadAttention(self.hidden_size, num_heads=num_heads)
        ...
        self.hlstm2 = nn.ModuleList([WeightedBiGRU(input_dim=self.hidden_size, hidden_dim=self.hidden_size)])




        self.attention2 = MultiHeadAttention(self.hidden_size, num_heads=num_heads)
